...
def GUI_init(val_dict):
    ...
    init_2labels(val_dict, 'airspeed', label1_text='Airspeed: ', row1=9, column1=1, row2=9, column2=2)
    init_2labels(val_dict, 'groundspeed', label1_text='Groundspeed: ', row1=10, column1=1, row2=10, column2=2)
    init_2labels(val_dict, 'gimbal_roll', label1_text='Gimbal roll: ', row1=11, column1=1, row2=11, column2=2)
    init_2labels(val_dict, 'gimbal_pitch', label1_text='Gimbal pitch: ', row1=12, column1=1, row2=12, column2=2)
    init_2labels(val_dict, 'gimbal_yaw', label1_text='Gimbal yaw: ', row1=13, column1=1, row2=13, column2=2)
