...
def GUI_init():
	...
	GUI_init_2labels('ch1', label1_text='Ch1: ', row1=1, column1=5, row2=1, column2=6)
	GUI_init_2labels('ch2', label1_text='Ch2: ', row1=2, column1=5, row2=2, column2=6)
	GUI_init_2labels('ch3', label1_text='Ch3: ', row1=3, column1=5, row2=3, column2=6)
	GUI_init_2labels('ch4', label1_text='Ch4: ', row1=4, column1=5, row2=4, column2=6)
	GUI_init_2labels('ch5', label1_text='Ch5: ', row1=5, column1=5, row2=5, column2=6)
	GUI_init_2labels('ch6', label1_text='Ch6: ', row1=6, column1=5, row2=6, column2=6)
	GUI_init_2labels('ch7', label1_text='Ch7: ', row1=7, column1=5, row2=7, column2=6)
	GUI_init_2labels('ch8', label1_text='Ch8: ', row1=8, column1=5, row2=8, column2=6)

	GUI_init_2labels('airspeed', label1_text='Airspeed: ', row1=1, column1=3, row2=1, column2=4)
	GUI_init_2labels('groundspeed', label1_text='Groundspeed: ', row1=2, column1=3, row2=2, column2=4)
	GUI_init_2labels('gimbal_roll', label1_text='Gimbal roll: ', row1=3, column1=3, row2=3, column2=4)
	GUI_init_2labels('gimbal_pitch', label1_text='Gimbal pitch: ', row1=4, column1=3, row2=4, column2=4)
	GUI_init_2labels('gimbal_yaw', label1_text='Gimbal yaw: ', row1=5, column1=3, row2=5, column2=4)
	GUI_init_2labels('last_heartbeat', label1_text='Last heartbeat: ', row1=6, column1=3, row2=6, column2=4)
	GUI_init_2labels('battery', label1_text='Battery: ', row1=7, column1=3, row2=7, column2=4)
    
	GUI_init_2labels('lat_loc', label1_text='Lat loc: ', row1=9, column1=1, row2=9, column2=2)
	GUI_init_2labels('lon_loc', label1_text='Lon loc: ', row1=10, column1=1, row2=10, column2=2)
	GUI_init_2labels('alt_loc', label1_text='Alt loc: ', row1=11, column1=1, row2=11, column2=2)
	GUI_init_2labels('lat_gl', label1_text='Lat gl: ', row1=9, column1=3, row2=9, column2=4)
	GUI_init_2labels('lon_gl', label1_text='Lon gl: ', row1=10, column1=3, row2=10, column2=4)
	GUI_init_2labels('alt_gl', label1_text='Alt gl: ', row1=11, column1=3, row2=11, column2=4)
	GUI_init_2labels('lat_gl_rel', label1_text='Lat gl rel: ', row1=9, column1=5, row2=9, column2=6)
	GUI_init_2labels('lon_gl_rel', label1_text='Lon gl rel: ', row1=10, column1=5, row2=10, column2=6)
	GUI_init_2labels('alt_gl_rel', label1_text='Alt gl rel: ', row1=11, column1=5, row2=11, column2=6)
